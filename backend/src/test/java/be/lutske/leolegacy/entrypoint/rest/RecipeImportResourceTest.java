...
import be.lutske.leolegacy.infrastructure.ai.LangChain4jRecipeExtractionAdapter;
...
class RecipeImportResourceTest {
    ...
    LangChain4jRecipeExtractionAdapter extractionAdapter;

    @BeforeEach
    void setup() {
        extractionAdapter = mock(LangChain4jRecipeExtractionAdapter.class);
        when(extractionAdapter.extractRecipeFromImage(any(), anyString())).thenReturn(
                new RecipeExtraction(
                        "Chocolate Mousse",
        ...
        QuarkusMock.installMockForType(extractionAdapter, LangChain4jRecipeExtractionAdapter.class);
    }
