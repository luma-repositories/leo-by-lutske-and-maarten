...
/**
 * Parses raw OCR/LLM text into a structured recipe proposal.
 */
@ApplicationScoped
    ...
    public ParseResult parse(String rawText) {
        if (rawText == null || rawText.isBlank()) {
            return new ParseResult(
                    new ProposedRecipeDto(null, null, null, null, null, null, null, null, null, null),
        ...
        if (ingredientStart != null && instructionStart != null && instructionStart > ingredientStart) {
            ...
            if (ingredients == null && preparation == null && !contentLines.isEmpty()) {
                return new ParseResult(
                        new ProposedRecipeDto(title, null, null, null, String.join("\n", contentLines), null, null, null, null, null),
        ...
        return new ParseResult(
                new ProposedRecipeDto(title, null, null, ingredients, preparation, null, null, null, null, null),
