...
/**
 * LangChain4j-based adapter implementing the domain {@link RecipeExtractionService} port.
 */
@ApplicationScoped
public class LangChain4jRecipeExtractionAdapter implements RecipeExtractionService {

    private static final Logger LOG = Logger.getLogger(LangChain4jRecipeExtractionAdapter.class);
    ...
    public LangChain4jRecipeExtractionAdapter(
    ...
    record LlmRecipeResponse(
            ...
            String source, List<String> tags, List<String> warnings
    ) {}
}
